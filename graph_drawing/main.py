...
def parse_args():
    ...
    parser.add_argument('-gt', '--graph-type', type=str, default="cycle", choices=["all", "cycle", "tree", "bipartite", "outerplanar", "grid", "atlas", "complete"], help="Type of graph to generate")
